...
# data.
#
if 'use_swin' in opt and opt.use_swin:
    h, w = 224, 224
else:
    h, w = 256, 128
...
# Path to Images
queryPath_veri="../../dataset/data/VeRi/image_query/"
queryList_veri="../../list/veri_query_list.txt"
galleryPath_veri="../../dataset/data/VeRi/image_test/"
...
#gen clusters
pred = eval_cluster(gallery_feature.cpu(),gallery_label)

gen_clustered_data(5, pred,len(set(gallery_label)) , "../dataset/data/VeRi/image_test", f"./model/{opt.name}/cluster", "../dataset/data/VeRi/name_test.txt")
