...
def eval_cluster(pred_feats, true_labels):

    transformed_feat = PCA(n_components=2).fit_transform(pred_feats)
...
def gen_clustered_data(
    size, pred_labels, no_of_classes, img_dir, save_dir, filepath_list_path
):
